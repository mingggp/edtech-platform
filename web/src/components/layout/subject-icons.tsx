...
const PATHS: Record<SubjectId | 'all', string> = {
  ...
  // ตัวต้านทานในวงจร — สายไฟเข้า/ออก + ซิกแซกกลาง (หมิงเลือกเอง แทนวงโคจรอะตอม)
  phys: '<path d="M2 12h3.2"/><path d="M18.8 12H22"/><path d="m5.2 12 1.6-4 2.4 8 2.4-8 2.4 8 2.4-8 1.6 4"/>',
