...
const SUBJECTS = [
  ...
  { code:'TGAT1', name:'TGAT1', sub:'การสื่อสารภาษาอังกฤษ', max:100, group:'tgat', subj:'tgat' },
  { code:'TGAT2', name:'TGAT2', sub:'การคิดอย่างมีเหตุผล',  max:100, group:'tgat', subj:'tgat' },
  { code:'TGAT3', name:'TGAT3', sub:'สมรรถนะการทำงาน',      max:100, group:'tgat', subj:'tgat' },
  { code:'TPAT1', name:'TPAT1', sub:'กสพท',                 max:100, group:'tpat', subj:'tpat' },
  { code:'TPAT2', name:'TPAT2', sub:'ศิลปกรรมศาสตร์',        max:100, group:'tpat', subj:'tpat' },
  { code:'TPAT3', name:'TPAT3', sub:'วิทย์ เทคโนโลยี วิศวกรรม', max:100, group:'tpat', subj:'tpat' },
  { code:'TPAT4', name:'TPAT4', sub:'สถาปัตยกรรมศาสตร์',     max:100, group:'tpat', subj:'tpat' },
  { code:'TPAT5', name:'TPAT5', sub:'ครุศาสตร์-ศึกษาศาสตร์', max:100, group:'tpat', subj:'tpat' },
...
const GROUPS = [
  ...
  { id:'tgat',   name:'TGAT',    subj:'tgat', open:true },
  { id:'tpat',   name:'TPAT',    subj:'tpat', open:false },
  { id:'alevel', name:'A-Level', subj:'math', open:true },
];

/* ---------- mock programs (ตัวอย่าง — เกณฑ์สมจริงแต่ไม่ใช่ข้อมูลจริง) ---------- */
const PROGRAMS = [
  { id:'cu-cpe', uni:'จุฬาลงกรณ์มหาวิทยาลัย', faculty:'วิศวกรรมศาสตร์', field:'คอมพิวเตอร์', round:'รอบ 3 Admission', quota:90, subj:'tpat',
  ...
  { id:'cu-eng', uni:'จุฬาลงกรณ์มหาวิทยาลัย', faculty:'วิศวกรรมศาสตร์', field:'รวมสาขา', round:'รอบ 3 Admission', quota:380, subj:'tpat',
    criteria:[{code:'TGAT1',w:10},{code:'TGAT2',w:10},{code:'TPAT3',w:50},{code:'AL_MATH1',w:20},{code:'AL_PHYS',w:10}],
    gpaxMin:null, statMin:64.85, statMax:86.20, statYear:2568 },
  { id:'tu-ce', uni:'มหาวิทยาลัยธรรมศาสตร์', faculty:'วิศวกรรมศาสตร์', field:'โยธา', round:'รอบ 3 Admission', quota:60, subj:'tpat',
  ...
  { id:'ku-eng', uni:'มหาวิทยาลัยเกษตรศาสตร์', faculty:'วิศวกรรมศาสตร์', field:'เครื่องกล', round:'รอบ 3 Admission', quota:110, subj:'tpat',
  ...
  { id:'kmitl-arch', uni:'สจล. (ลาดกระบัง)', faculty:'สถาปัตยกรรมศาสตร์', field:'สถาปัตยกรรมหลัก', round:'รอบ 3 Admission', quota:70, subj:'tgat',
  ...
  { id:'cu-acc', uni:'จุฬาลงกรณ์มหาวิทยาลัย', faculty:'พาณิชยศาสตร์และการบัญชี', field:'บัญชี', round:'รอบ 3 Admission', quota:150, subj:'tgat',
