...
# --------------------------------------------------------------------------
COURSES = [
    dict(slug='amath-calculus', subject='math', level='alevel', ribbon='hot',
    ...
    dict(slug='amath-alevel1', subject='math', level='alevel', ribbon='rec',
    ...
    dict(slug='math-trig', subject='math', level='m5', ribbon='free',
    ...
    dict(slug='math-func', subject='math', level='m4', ribbon='rec',
    ...
    dict(slug='aphys-full', subject='phys', level='alevel', ribbon='hot',
    ...
    dict(slug='tpat3-latest', subject='tpat3', level=None, ribbon='hot',
    ...
    dict(slug='tpat3-mock', subject='tpat3', level=None, ribbon='new',
    ...
    dict(slug='tgat2-logic', subject='tgat2', level=None, ribbon='rec',
